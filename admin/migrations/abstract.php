 ...
 *  "DT_Prayer_Campaign_Migration_xxxx", where xxxx is the migration number. For
 *  example:
 *
 ...
 *      }
 *
 *  See the documentation for DT_Prayer_Campaign_Migration_Engine.
 *
 */
abstract class DT_Prayer_Campaign_Migration {
    ...
    /**
     * @throws \DT_Prayer_Campaign_Migration_Test_Exception Table $name not as expected, see error log.
     */
    protected function test_expected_tables() {
        ...
        foreach ( $expected_tables as $name => $expected_table ) {
            ...
            if ( $got_table !== $expected_table ) {
                ...
                throw new DT_Prayer_Campaign_Migration_Test_Exception( "Table $name not as expected, see error log" );
            }
        }
    }
...
/**
 * Class DT_Prayer_Campaign_Migration_Test_Exception
 */
class DT_Prayer_Campaign_Migration_Test_Exception extends Exception {
}
