...
/**
 * For more documentation, see the class DT_Prayer_Campaign_Migration in file
 * dt-core/migrations/abstract.php
 */
class DT_Prayer_Campaigns_Migration_Engine
{
        ...
        foreach ( $filenames as $filename ) {
            if ( $filename[0] !== '.' && $filename !== 'abstract.php' ){
                if ( preg_match( '/^([0-9][0-9][0-9][0-9])(-.*)?\.php$/i', $filename, $matches ) ) {
                    ...
                    $migration_name = sprintf( 'DT_Prayer_Campaign_Migration_%04d', $got_migration_number );
     ...
     *
     * @throws \Exception ...
     * @throws \DT_Prayer_Campaign_Migration_Lock_Exception ...
     * @throws \Throwable ...
     */
    public static function migrate( int $target_migration_number ) {
        ...
        while ( true ) {
            $current_migration_number = get_option( 'dt_prayer_campaign_migration_number' );
            ...
            try {
                ...
                update_option( 'dt_prayer_campaign_migrate_last_error',
                    array(
...
//            }
    ...
    public static function get_current_db_migration(){
        return get_option( 'dt_prayer_campaign_migration_number', 0 );
    }
...
class DT_Prayer_Campaign_Migration_Lock_Exception extends Exception
{
    public function __construct( $message = null, $code = 0, Exception $previous = null ) {
         ...
         */
        $last_migration_error = get_option( 'dt_prayer_campaign_migrate_last_error' );
        if ( $message === null ) {
