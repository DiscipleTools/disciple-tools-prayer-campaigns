...
add_action( 'wp_enqueue_scripts', function (){
    ...
    wp_enqueue_style( 'font-awesome', 'https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.7.0/css/fontawesome.min.css', array(), '6.7.0' );
    ...
    wp_enqueue_style( 'wordpress-styles', trailingslashit( plugin_dir_url( __FILE__ ) ) . 'css/wordpress_styles.css', array(), filemtime( trailingslashit( plugin_dir_path( __FILE__ ) ) . 'css/wordpress_styles.css' ) );
