...
class DT_Subscriptions_Base extends DT_Module_Base {
    ...
    public function __construct() {
        ...
        add_filter( 'dt_details_additional_tiles', [ $this, 'dt_details_additional_tiles' ], 500, 2 );
        add_action( 'dt_details_additional_section_post', [ $this, 'dt_details_additional_section' ], 500, 2 );
